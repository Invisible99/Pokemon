...
public:
	...
	void Draw( const Point2f& destBottomLeft = {}, const Rectf& srcRect = {}, const Color4f& overlayColor = {}) const;
	void Draw( const Rectf& destRect, const Rectf& srcRect = {}, const Color4f& overlayColor = {}) const;
